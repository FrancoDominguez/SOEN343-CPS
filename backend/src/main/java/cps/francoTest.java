...
public class francoTest {
  ...
  public static void testDAOs() {
    try {
      ...
      // ArrayList<Delivery> deliveries = deliveryDAO.fetchAllByClientId(clientObj.getId());

      // test updating pickup time
      // set fetchedFlexDeliv a new time
      // save fetchedFlexDeliv

      // test updating pickup location
      // set fetchedFlexDeliv a new pickup location
      // save fetchedFlexDeliv
